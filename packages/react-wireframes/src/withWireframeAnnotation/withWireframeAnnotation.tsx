...
export function withWireframeAnnotation(options: WireframeAnnotationOptions) {
  return function withWireframeAnnotationComponent<P extends Record<string, unknown>>(WrappedComponent: ComponentType<P> | keyof JSX.IntrinsicElements) {
...
export const withWireframeAnnotationInterfaceDefinition = (params: {withWireframeAnnotation: (options: WireframeAnnotationOptions) => // eslint-disable-line @typescript-eslint/no-unused-vars
    <P extends Record<string, unknown>>(WrappedComponent: ComponentType<P> | keyof JSX.IntrinsicElements) => ReactElement<WireframeAnnotationProps>;}) => null;

/* istanbul ignore next */
export const WireframeAnnotationPropsInterfaceDefinition = <P extends Record<string, unknown>>(
  {
